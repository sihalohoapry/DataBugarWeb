    ...
    <div class="container">
        <div class=" justify-content-center ">
            <div class="card text-center">
                        ...
                        @else border-success @endif  mb-3">
                                ...
                                <div class="card-body ">
                                    <h5
                                     ...
                                     text-success @endif ">
                                        {{ $resultIMT->result }}</h5>
                                    <p class="card-text">Angka IMT mu <b style="color: black">{{ $inputResult }}</b> hasil
                                        dari
                                        berat badan
                ...
                @else
                    <div class="card-body row">
                        <p>Hasil belum bisa di ketahui, segera hubungungi admin untuk melengkapi hasil tes kebugaran dan IMT
                        </p>
                        <div class="col-md-6"><a href="{{ url()->previous() }}" class="btn btn-primary float-end">Back</a>
                        </div>

                        <div class="col-md-6"><a href="{{ route('login') }}" class="btn btn-success float-start">Login</a>
                        </div>
                    </div>
                @endif

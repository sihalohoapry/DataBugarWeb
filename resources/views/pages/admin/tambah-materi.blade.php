                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('create-materi') }}" method="POST"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <select class="form-control" name="judul" id="judul" required>
                                            ...
                                            <div class="form-group col-md-12 mb-2">
                                                ...
                                                <textarea type="text" rows="5" class="form-control" name="deskripsi" placeholder="Silahkan Masukkan Deskripsi"
                                                    required></textarea>

                    ...
                    <div class="modal fade" id="ModalDelete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                <div class="modal-dialog" role="document">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="{{ route('delete-materi') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                    ...
                    <div class="page-hero page-container " id="page-hero">
                        <div class="padding d-flex pt-0">
                            <div class="page-title">
                                <h2 class="text-md text-highlight">Materi</h2>
                                <small class="text-muted">Daftar list materi terdaftar</small>
                            </div>
                            <div class="flex"></div>
                            <div>
                                <a href="{{ route('tambah-materi')}}" class="btn btn-md text-muted">
                                    <span class="d-none d-sm-inline mx-1">Tambah Materi</span>
                                ...
                                <table id="datatable" class="table table-theme table-row v-middle" >
                                    <thead>
                                        <tr>
                                            ...
                                            <th><span class="text-muted">Url</span></th>
